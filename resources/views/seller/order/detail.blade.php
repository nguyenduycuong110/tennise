...
@include('seller.dashboard.component.breadcrumb', ['title' => $config['seo']['detail']['title']])
            ...
            <div class="ibox">
                ...
                <div class="ibox-content">
                    <table class="table-order">
                        <tbody>
                            @php
                                $sellerTotal = 0; // Khởi tạo tổng tiền cho seller
                            @endphp
                            ...
                            @php
                                ...
                                $sellerTotal += $val->pivot->price * $qty;
                                // $shipping = json_decode($orderDetail[$val->id], TRUE);
                            @endphp
                            <tr class="order-item">
                                <td>
                                    <div class="image">
                            ...
                            <tr>
                                ...
                                <td class="text-right">{{ convert_price($sellerTotal, true) }} ₫</td>
                            </tr>
                            {{-- <tr>
                            ...
                            <tr>
                                ...
                                <td class="text-right" style="font-size:18px;">
                                    <strong style="color:blue;">{{ convert_price($sellerTotal - $order->promotion['discount'] + $order->shipping, true) }} ₫</strong>
                                </td>
                            </tr>
                        </tbody>
